...
class BalanceDisplay extends Phaser.GameObjects.Sprite{
    constructor( scene , x , y, balBg = '' ,balance , depth, fontSize , bitmapText ){
        ...
        this.coinEmitter = particle.createEmitter({
            frame : 0,
            x : this.x,
            y : this.y,
            frequency : -1,
        ...
        bDisplay.sparkEmitter = particle.createEmitter({
            frame : 1,
            x : this.x,
            y : this.y,
            frequency : -1,
